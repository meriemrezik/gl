...
<head>
    ...
    <link rel="stylesheet" href="liscss2.css">
</head>
<body>
...
<section class="patient-list">
    <form action="nvlis2php.php" method="post">
                    ...
                    <?php foreach ($patients as $patient) : ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <select name="medecin[<?php echo $patient['id']; ?>]" id="medecin<?php echo $patient['id']; ?>">
                                <option value="affecter?">affecter?</option>
                                    <?php foreach ($medecins as $medecin) : ?>
                                        <option value="<?php echo $medecin['nom'] . ' ' . $medecin['specialite']; ?>"><?php echo $medecin['nom'] . ' ' . $medecin['specialite']; ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </td>
                        </tr>
